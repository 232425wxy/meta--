...
type PublicKeySeg struct {
	...
	A0        []byte `protobuf:"bytes,4,opt,name=a0,proto3" json:"a0,omitempty"`
}
...
func (m *PublicKeySeg) GetSk() []byte {
	if m != nil {
		return m.Sk
	}
	return nil
...
func (m *PublicKeySeg) GetA0() []byte {
	if m != nil {
		return m.A0
	}
	return nil
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	0x25, 0xb1, 0x24, 0x11, 0xac, 0x89, 0x27, 0x08, 0xcc, 0x86, 0x18, 0xca, 0x0c, 0x35, 0x54, 0x29,
	...
	,
}
...
func (m *PublicKeySeg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.A0) > 0 {
		i -= len(m.A0)
		copy(dAtA[i:], m.A0)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.A0)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Sk) > 0 {
		i -= len(m.Sk)
		copy(dAtA[i:], m.Sk)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.Sk)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *PublicKeySeg) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field A0", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.A0 = append(m.A0[:0], dAtA[iNdEx:postIndex]...)
			if m.A0 == nil {
				m.A0 = []byte{}
			}
			iNdEx = postIndex
